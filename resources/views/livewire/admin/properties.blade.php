                    ...
                    <table class="table table-striped table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-center align-middle text-primary">كروه وزكي</th>
                                <th class="text-center align-middle text-primary">عنوان كروه وزكي</th>
                        ...
                        <tbody>
                            @foreach ($properties as $index => $property)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        {{ \Hekmatinasser\Verta\Verta::instance($property->created_at)->format('%B %d، %Y') }}
                                    </td>
                                </tr>
                            @endforeach
