                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <figure class="avatar avatar">
                                            <img src="{{ url('images/admin/users/big/' . $user->photo) }}"
                                    ...
                                    <td class="text-center align-middle"
                                        ...
                                        @else
                                            <span class="cursor-pointer badge badge-danger">غير فعال</span>
                                        @endif
                                    </td>
                                    <td class="text-center align-middle">
                                    ...
                                    <td class="text-center align-middle">
                                        {{ \Hekmatinasser\Verta\Verta::instance($user->created_at)->format('%B %d، %Y') }}
                                    </td>
                                </tr>
                            @endforeach
