                    ...
                    <table class="table table-striped table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-center align-middle text-primary">قيمت </th>
                                <th class="text-center align-middle text-primary">تعداد </th>
                                <th class="text-center align-middle text-primary">كالري</th>
                                <th class="text-center align-middle text-primary">ويزكي ها</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a class="btn btn-outline-info"
                                            href="{{ route('create.product.gallery', $product->id) }}">
                                            كالري
                                        </a>
                                    </td>
                                    <td class="text-center align-middle">
                                        <a class="btn btn-outline-info"
                                            href="{{ route('create.product.propertie', $product->id) }}">
                                            ويزكي ها
                                        </a>
                                    </td>
                                    <td class="text-center align-middle">
                                    ...
                                    <td class="text-center align-middle">
                                        {{ \Hekmatinasser\Verta\Verta::instance($product->created_at)->format('%B %d، %Y') }}
                                    </td>
                                </tr>
                            @endforeach
