                    ...
                    <table class="table table-striped table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-center align-middle text-primary">نام رنك</th>
                                <th class="text-center align-middle text-primary">كود رنك</th>
                                <th class="text-center align-middle text-primary">رنك</th>
                        ...
                        <tbody>
                            @foreach ($colors as $index => $color)
                                <tr>
                                    ...
                                    <td class="text-center align-middle" style="background-color: {{ $color->code }};  width: 50px;"></td>
                                    ...
                                    <td class="text-center align-middle">
                                        {{ \Hekmatinasser\Verta\Verta::instance($color->created_at)->format('%B %d، %Y') }}
                                    </td>
                                </tr>
                            @endforeach
                ...
                @section('scripts')
                    <script>
                        window.addEventListener('deleteColor', event => {
                            Swal.fire({
                                text: "ايا از حذف رنك مطمئن هستيد ؟",
                                icon: "warning",
