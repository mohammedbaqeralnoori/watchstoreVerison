                    ...
                    <table class="table table-striped table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-center align-middle text-primary">نام دسته بندي</th>
                                <th class="text-center align-middle text-primary">دسته بدر </th>
                        ...
                        <tbody>
                            @foreach ($categories as $index => $category)
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        {{ \Hekmatinasser\Verta\Verta::instance($category->created_at)->format('%B %d، %Y') }}
                                    </td>
                                </tr>
                            @endforeach
                ...
                @section('scripts')
                    <script>
                        window.addEventListener('deleteCategory', event => {
                            Swal.fire({
                                text: "ايا از حذف دسته بندي مطمئن هستيد ؟",
                                icon: "warning",
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    Swal.fire({
                                        text: "دسته بندي با موفقيت حذف شد",
                                        icon: "success"
                                    });
                                }
                            });
