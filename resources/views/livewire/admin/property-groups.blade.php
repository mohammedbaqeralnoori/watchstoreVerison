                    ...
                    <table class="table table-striped table-hover">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="text-center align-middle text-primary">نام كروه ويزكي ها</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a class="btn btn-outline-info"
                                            href="{{ route('property_groups.edit', $property_group->id) }}">
                                            ویرایش
                                        </a>
                                    </td>
                                    <td class="text-center align-middle">
                                        <a class="btn btn-outline-danger"
                                            wire:click='deletePropertyGroup({{ $property_group->id }})'>
                                            حذف
                                        </a>
                                    </td>
                                    <td class="text-center align-middle">
                                        {{ \Hekmatinasser\Verta\Verta::instance($property_group->created_at)->format('%B %d، %Y') }}
                                    </td>
                                </tr>
                            @endforeach
