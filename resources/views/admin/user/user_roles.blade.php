                                    ...
                                    <div class="col-6 offset-3">
                                        <div class="list-group" id="list-tab" role="tablist">
                                            <a class="list-group-item list-group-item-action active" id="list-profile-list"
                                                data-toggle="list" href="#" role="tab">نقش های کاربر
                                                {{ $user->name }}</a>
                                            @foreach ($roles as $role)
                                                <div class="form-check  d-flex align-items-center">
                                                    <input @if ($user->hasRole($role->name)) checked @endif type="checkbox"
                                                        class="form-check-input" name="roles[]" value="{{ $role->name }}"
                                                        id="exampleCheck1">
