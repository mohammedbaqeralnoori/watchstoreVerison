...
//     Route::get('/login', [ProfileController::class, 'login'])->name('auth.login');
...
Route::prefix('admin')->middleware('auth', 'admin')->group(function () {
    ...
    Route::get('create_product_properties/{id}', [ProductController::class, 'addPropertie'])->name('create.product.propertie');
    Route::post('store_product_properties/{id}', [ProductController::class, 'storePropertie'])->name('store.product.propertie');
