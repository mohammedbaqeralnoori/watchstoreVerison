...
class PropertyGroupController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('property_groups.index')->with('message', 'كروه وزكي ها با موفقيت ايجاد شد');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('property_groups.index')->with('message', 'كروه وزكي ها با موفقيت ويرايش شد');
    }
