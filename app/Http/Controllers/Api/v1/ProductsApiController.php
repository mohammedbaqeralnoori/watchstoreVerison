...
class ProductsApiController extends Controller
{
    ...
    public function productsByCategory($id)
    {
        return response()->json([
            ...
            'data' => [
                keys::brands => Brand::getAllBrands(),
                Keys::products_by_category => ProductRepository::getProductByCategory($id)->response()->getData(true),
            ],
        ], 200);
    }
    ...
    public function productsByBrand($id)
    {
        return response()->json([
            ...
            'data' => [
                keys::brands => Brand::getAllBrands(),
                Keys::products_by_brand => ProductRepository::getProductByBrand($id)->response()->getData(true),
            ],
        ], 200);
    }
